...
def run(vbs=False):
    ...
    print('list(it.groupby(adic, op.itemgetter("foo"))):')
    print(f'  {list(it.groupby(adic, op.itemgetter("foo")))}')
    print('[(key, list(group)) for key, group in it.groupby(adic, op.itemgetter("foo"))]:')
    print(f'  {[(key, list(group)) for key, group in it.groupby(adic, op.itemgetter("foo"))]}')
